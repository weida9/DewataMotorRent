...
# Setup Git Repository for Dewata Motor Project
...
git commit -m "feat: initial commit - complete dewata motor rental system

- Add Flask web application with session authentication
- Implement role-based access control (superadmin/admin)
- Add motor management with image upload
- Create responsive UI with Tailwind CSS
- Include password management features
- Add comprehensive database schema with sample data
- Include project documentation and contribution guidelines"
